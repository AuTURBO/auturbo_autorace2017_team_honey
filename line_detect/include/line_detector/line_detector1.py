...
#         return bw, edge_color
    ...
    def _HoughLine2(self, edge,hough_threshold,hough_min_line_length,hough_max_line_gap):
    ...
    def detectLines2(self, color, hough_threshold, hough_min_line_length , hough_max_line_gap):
        ...
        lines = self._HoughLine2(edge_color, hough_threshold, hough_min_line_length , hough_max_line_gap)
	if self.parking == 0 :
            centers, normals = self._findNormal(bw, lines)
	else :
            centers = None
